...
public class JPushPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(FlutterPluginBinding flutterPluginBinding) {
    channel =
      new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "jpush");
  ...
  public void scheduleCache() {
    ...
    if (dartIsReady) {
      ...
      List<Map<String, Object>> openNotificationCacheList =
        JPushPlugin.openNotificationCache;
      for (Map<String, Object> notification : openNotificationCacheList) {
        JPushPlugin.instance.channel.invokeMethod(
          "onOpenNotification",
          notification
        );
  ...
  public void getSCToken(MethodCall call, final Result result) {
    ...
    rec.setShowCallBack(
      new JPushEventReceiver.ShowCallBack() {
        @Override
  ...
  public void sendLocalNotification(MethodCall call, Result result) {
    ...
    try {
      ...
      HashMap<String, Object> extra = (HashMap<String, Object>) map.get(
        "extra"
      );
  ...
  public static class JPushReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      if (action.equals(JPushInterface.ACTION_REGISTRATION_ID)) {
        String rId = intent.getStringExtra(
  ...
  static void transmitMessageReceive(
    String message,
    Map<String, Object> extras
  ) {
    Log.d(
      TAG,
      "transmitMessageReceive " + "message=" + message + "extras=" + extras
    );
  ...
  static void transmitNotificationReceive(
    String title,
    String alert,
    Map<String, Object> extras
  ) {
